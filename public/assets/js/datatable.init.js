...
try {
    ...
    document.querySelector("button.csv").addEventListener("click", () => {
        ...
        document.querySelector("button.json").addEventListener("click", () => { b.export({ type: "json", download: !0, escapeHTML: !0, space: 3 }) })
} catch (e) { }
try {
    document.addEventListener("DOMContentLoaded", function () {
        var c = document.querySelector("[name='select-all']"),
            n = document.querySelectorAll("[name='check']"),
            e = (c?.addEventListener("change", function () {
                var t = c.checked; n.forEach(function (e) { e.checked = t })
            }),
                n.forEach(function (e) {
                    e.addEventListener("click", function () {
                        var e = n.length, t =
                            document.querySelectorAll("[name='check']:checked")
                                .length; t <= 0 ? (c.checked = !1, c.indeterminate = !1) : e === t ? (c.checked = !0, c.indeterminate = !1) : (c.checked = !0, c.indeterminate = !0)
                    })
                }),
                document.querySelectorAll("table > thead > tr > th"),
                th.querySelector("button:first-child")); e && e.classList.remove("datatable-sorter")
